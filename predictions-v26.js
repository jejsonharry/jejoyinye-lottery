...
// Classification and moving numbers are controlled secondary signals
// inside each 60/30/10 source component. Actual evidence stays primary.
const MODERN_CLASSIFICATION_SHARE = 0.20;
const MODERN_MOVING_SHARE = 0.10;
const MODERN_ACTUAL_RESULTS_SHARE =
    1 - MODERN_CLASSIFICATION_SHARE - MODERN_MOVING_SHARE;
...
// =========================================================
// MODERN RESULTS + CLASSIFICATION + MOVING PREDICTION — V26
...
// Inside each source component, actual results contribute 70%,
 // the Modern classification chart 20%, and moving numbers 10%.
// =========================================================
